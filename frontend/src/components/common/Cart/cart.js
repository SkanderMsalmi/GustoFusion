...
const Cart = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8085/api/livraison/cart/cartItems") // Replace with your API endpoint
      .then((response) => {
  ...
  function handleOrder() {
    ...
    axios
      .post("http://localhost:8085/api/livraison/orders?cartId=" + 1, {
        orderDateTime: "2023-10-19T14:30:00",
        orderStatus: "ready",
  ...
  return (
    <section className="book-a-table main-div">
      <div class="tableCart-container">
        ...
        <button onClick={openDialogEvent} class="golden-button">
          Proceed to order
        </button>
      </div>
              ...
              <div className="orderForm">
                <div>
                        ...
                        if (item.typeShow == 1)
                          return (
                            <div key={index} class="col-md-6">
                              <input
                                value={postForm[item.formAttr]}
                                onChange={(e) =>
                                  setPostForm({
                                    ...postForm,
                                    [item.formAttr]: e.target.value,
                                  })
                                }
                                type={item.type}
                  ...
                  <div className="btnHolder">
                    <button class="submitButton" onClick={handleOrder}>
                      checkout
                    </button>
                  </div>
                </div>
